...
webpackEmptyAsyncContext.id = 18771;
...
webpackEmptyAsyncContext.keys = () => ([]);
webpackEmptyAsyncContext.resolve = webpackEmptyAsyncContext;
webpackEmptyAsyncContext.id = 68363;
module.exports = webpackEmptyAsyncContext;
...
webpackEmptyAsyncContext.keys = () => ([]);
webpackEmptyAsyncContext.resolve = webpackEmptyAsyncContext;
webpackEmptyAsyncContext.id = 16467;
module.exports = webpackEmptyAsyncContext;
...
webpackEmptyAsyncContext.keys = () => ([]);
webpackEmptyAsyncContext.resolve = webpackEmptyAsyncContext;
webpackEmptyAsyncContext.id = 32202;
module.exports = webpackEmptyAsyncContext;
...
/* harmony import */ var _earendil_works_pi_ai__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(73470);
/* harmony import */ var _earendil_works_pi_ai_providers_anthropic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(85635);
...
/* harmony export */ });
/* harmony import */ var _earendil_works_pi_coding_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74010);
...
async function createModelRuntime(model, legacyAnthropicApiKey) {
    const modelRuntime = await _earendil_works_pi_coding_agent__WEBPACK_IMPORTED_MODULE_0__.ModelRuntime.create();
...
/* harmony export */   uP: () => (/* binding */ FileReportSchema),
/* harmony export */   xb: () => (/* binding */ AuxiliaryUsageMapSchema)
/* harmony export */ });
/* unused harmony exports normalizeSeverity, SeveritySchema, ConfidenceSchema, CONFIDENCE_ORDER, filterFindingsBySeverity, filterFindingsByConfidence, SourceSnippetLineSchema, AuxiliaryUsageAttributionMapSchema, ErrorCodeSchema, isExtractionErrorCode, HunkFailureSchema, TraceSpanSchema, PullRequestActionSchema, FileChangeSchema, DiffContextSourceSchema, PullRequestContextSchema, RepositoryContextSchema, RetryConfigSchema */
...
const FileChangeSchema = zod__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ik({
    filename: zod__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Yj(),
    previousFilename: zod__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Yj().optional(),
